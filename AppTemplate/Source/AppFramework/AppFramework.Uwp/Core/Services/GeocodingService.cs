...
namespace AppFramework.Core.Services
{
    ...
    public sealed class GeocodingService : ServiceBase
    {
        ...
        /// <returns>String name representing the specified location.</returns>
        public async Task<string> GetCityStateAsync(ILocationModel loc, CancellationToken ct)
        {
            // Reverse geocode the specified geographic location.
            var result = await MapLocationFinder.FindLocationsAtAsync(loc?.AsGeoPoint()).AsTask(ct);
        ...
        /// <param name="ct">Cancellation token.</param>
        /// <returns>String name representing the specified location.</returns>
        public async Task<string> GetCountryAsync(ILocationModel loc, CancellationToken ct)
        {
            // Reverse geocode the specified geographic location.
            var result = await MapLocationFinder.FindLocationsAtAsync(loc?.AsGeoPoint()).AsTask(ct);
