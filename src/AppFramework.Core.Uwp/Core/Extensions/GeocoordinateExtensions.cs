...
{
    public sealed class GenericLocationModel : BaseLocationModel
    {
    }
    ...
    internal static class GeocoordinateExtensions
    {
        ...
        public static BaseLocationModel AsLocationModel(this Geocoordinate coord)
        {
            if (coord != null)
            {
                return new GenericLocationModel()
                {
