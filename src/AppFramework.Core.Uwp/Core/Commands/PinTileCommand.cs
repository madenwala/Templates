...
namespace AppFramework.Core.Commands
{
    ...
    public sealed class PinTileCommand : GenericCommand<IModel>
    {
        ...
        public PinTileCommand()
            : base("PinTileCommand", null, BasePlatform.CurrentCore.Notifications.HasTile)
        {
        }
        ...
        public async override void Execute(object parameter)
        {
            ...
            {
                // Create tile
                if (await BasePlatform.CurrentCore.Notifications.CreateOrUpdateTileAsync(parameter as IModel))
                {
    ...
    public sealed class UnpinTileCommand : GenericCommand<IModel>
    {
        ...
        public UnpinTileCommand()
            : base("UnpinTileCommand", null, BasePlatform.CurrentCore.Notifications.HasTile)
        {
        }
        ...
        public async override void Execute(object parameter)
        {
            ...
            {
                // Delete tile
                if (await BasePlatform.CurrentCore.Notifications.DeleteTileAsync(parameter as IModel))
                {
