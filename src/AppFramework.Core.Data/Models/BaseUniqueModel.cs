...
{
    /// <summary>
    /// Implementation of <see cref="INotifyPropertyChanged"/> to simplify modC:\Git\Templates\src\AppFramework.Core.Data\Models\BaseUniqueModel.csels that have a unique ID to represent the model.
    /// </summary>
